...
class Autoload extends \CodeIgniter\Config\AutoloadConfig
{
	...
	public function __construct()
	{
		...
		$classmap = [
			...
			'PropertyModel' => APPPATH . 'Models/PropertyModel.php',
			'PropertyUserModel' => APPPATH . 'Models/PropertyUserModel.php',
			'PropertyUserEntity' => APPPATH . 'Entities/PropertyUserEntity.php',
